...
class MyFTPClient(object):
    ...
    def __init__(self,server_address):
        ...
        self.donwloads = os.getcwd() + "/downloads/"
        try:
    ...
    def put(self,command):
        ...
        #print(str(self.dsocket.recvfrom(25600)[0],"utf-8"))
    ...
    def get(self,command):
         ...
         if data.split('-')[0] == '550': print(data)
         else:
             ...
             if len(cmd_parts) > 1:
                try:
                    ...
                    print("{} received from server, but could'nt be saved locally.".format(filepath))
                    print(e)
